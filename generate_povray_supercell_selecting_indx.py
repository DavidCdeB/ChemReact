...
#molecule = molecule.repeat((1, 1, 2)) # here we expand the supercell
all_indices = [38, 30, 39, 34, 31, 41, 40, 36, 23, 28, 29, 26, 24, 27, 25, 14, 12, 10, 22, 21, 9, 20, 19]
molecule = molecule[all_indices]
...
rotation = '86.13986139684694x, -56.01254948597461y, -57.85917831549761z' # found using ASE-GUI menu 'view -> rotate'
